...
#
#   basalarea.py
#   Load and compare basal area data through 2014
#   between  MS Access and SQL Server
#
#   Gareth Rowell - 20240917
#
###############################################################

# start the IPython session here:
# C:\Users\GRowell\bb-validate\PartTwo
...
# And what is the count by year?
# Validate this result using R tidyverse
